...
- Album view — sorted by DiscNumber then TrackNumber for correct album order
- Album art — displays embedded art; falls back to album-level cached art when unavailable
