...
in
{
  ...
  # Project-specific Claude permissions — merges with metadev's baseline via lib.mkMerge.
  # metadev already provides: mcp__*__* wildcards, enableAllProjectMcpServers,
  # 14 core enabledMcpjsonServers, and hooks.PreToolUse.
  # We add only what is MDMA-specific here.
  files.".claude/settings.local.json".json = lib.mkMerge [{
    permissions.allow = [
      # Bash allows
      "Bash(cargo check:*)"
      "Bash(cargo clippy:*)"
      "Bash(just deploy-dev:*)"
      "Bash(sshpass -p \"voidlinux\" ssh:*)"
      "Bash(sshpass:*)"
      "Bash(arp:*)"
      "Bash(avahi-browse:*)"
      "Bash(nmap:*)"
      ...
      "Bash(cargo test:*)"
      "Bash(cargo zigbuild:*)"
      "Bash(target/release/mdma:*)"
      "Bash(target/debug/mdma:*)"
      "Bash(ls:*)"
      "Bash(just library-cross:*)"
      "Bash(cargo run:*)"
      "Bash(just pi-scan:*)"
      "Bash(just deploy-library:*)"
      "Bash(just deploy-console:*)"
      "Bash(ssh -4 -i ~/.ssh/mdma_pi admin@mdma-909.local:*)"
      "Bash(just:*)"
      "Bash(ZIG_GLOBAL_CACHE_DIR=/tmp/zig-cache cargo zigbuild:*)"
      "Bash(getent hosts:*)"
      "Bash(avahi-resolve:*)"
      "Bash(MDMA_BANDCAMP_SOCKET=\"tcp://mdma-909.local:5556\" cargo run:*)"
      "Bash(git mv:*)"
      "Bash(chmod:*)"
      "Bash(ZIG_GLOBAL_CACHE_DIR=/tmp/zig-cache zig cc:*)"
      "Bash(MDMA_LIBRARY_SOCKET=\"tcp://mdma-909.local:5555\" cargo run:*)"
      "Bash(MDMA_LIBRARY_SOCKET=\"tcp://mdma-909.local:5555\" MDMA_PLAYBACK_SOCKET=\"tcp://mdma-909.local:5557\" cargo run:*)"
      "Bash(gh api:*)"
      "Bash(curl:*)"
      "Bash(python3:*)"
      "Bash(journalctl:*)"
      ...
      "Bash(scp:*)"
      "Bash(find:*)"
      "Bash(ZIG_GLOBAL_CACHE_DIR=/tmp/zig-cache just beacon-cross:*)"
      "Bash(MDMA_BANDCAMP_SOCKET=\"tcp://mdma-909.local:5556\" /home/johlrogge/projects/modular-digital-music-array/target/debug/mdma:*)"
      "Bash(MDMA_LIBRARY_SOCKET=\"tcp://mdma-909.local:5555\" /home/johlrogge/projects/modular-digital-music-array/target/debug/mdma library status:*)"
      "Bash(MDMA_LIBRARY_SOCKET=\"tcp://mdma-909.local:5555\" /home/johlrogge/projects/modular-digital-music-array/target/debug/mdma:*)"
      "Bash(ZIG_GLOBAL_CACHE_DIR=/tmp/zig-cache just deploy-playback:*)"
      "Bash(export MDMA_PLAYBACK_SOCKET=\"tcp://mdma-909.local:5557\")"
      "Bash(grep:*)"
      "Bash(mdma queue list:*)"
      "Bash(mdma get:*)"
      "Bash(echo:*)"
      "Bash(MDMA_GATEWAY=tcp://mdma-909.local:5555 cargo run:*)"
      "Bash(timeout:*)"
      "Bash(RC=$?)"
      "Bash(kill:*)"
      "Bash(pkill:*)"
      ...
      "Bash(git add:*)"
      "Bash(git commit:*)"
      "Bash(export MDMA_GATEWAY=\"tcp://mdma-909.local:5555\")"
      "Bash(mdma ping:*)"
      "Bash(mdma status:*)"
      "Bash(mdma search:*)"
      "Bash(mdma playback:*)"
      "Bash(mdma source list:*)"
      "Bash(devenv --version:*)"
      "Bash(devenv info:*)"
      "Bash(devenv version:*)"
      "Bash(nix eval:*)"
      ...
      "Bash(cargo doc:*)"
      "Bash(rustc:*)"
      "Bash(bash scripts/ci/build-playback.sh:*)"
      "Bash(mdma library list:*)"
      "Bash(mdma --help:*)"
      "Bash(mdma list:*)"
      "Bash(bash -n:*)"
      "Bash(/home/johlrogge/projects/modular-digital-music-array/target/debug/mdma search:*)"
      "Bash(/home/johlrogge/projects/modular-digital-music-array/target/debug/mdma get:*)"
      "Bash(/home/johlrogge/projects/modular-digital-music-array/target/debug/mdma:*)"
      "Bash(cargo fmt:*)"
      "Bash(mdma facts:*)"
      "Bash(nix flake show:*)"
      "Bash(nix flake metadata:*)"
      "Bash(nix-store --query --referrers:*)"
      "Bash(nix-store:*)"
      ...
      "Bash(nc:*)"
      "Bash(xbps-rindex:*)"
      "Bash(git flow feature start:*)"
      "Bash(mdma source status:*)"
      "Bash(git config:*)"
      "Bash(gh workflow run:*)"
      "Bash(gh run rerun:*)"
      "Bash(mdma --node mdma-909.local queue list:*)"
      "Bash(env:*)"
      "Bash(mdma:*)"
      "Bash(devenv processes stop:*)"
      "Bash(cargo clean:*)"
      "Bash(killall devenv cargo rustc)"
      "Bash(EXIT_CODE=$?)"
      "Bash(netstat:*)"
      "Bash(done)"
      "Bash(RUSTFLAGS=\"-D warnings\" cargo test:*)"
      "Bash(MDMA_NODE=mdma-909.local mdma search:*)"
      "Bash(sudo tar:*)"
      "Bash(xz -dc:*)"
      "Bash(tar t:*)"
      "Bash(tar xf:*)"
      ...
      "Bash(gh repo view:*)"
      "Bash(git status:*)"
      "Bash(git -C /home/johlrogge/projects/modular-digital-music-array commit -m \"fix\\(protocol\\): remove duplicate ResponseData::Queue variant\")"
      "Bash(git -C /home/johlrogge/projects/modular-digital-music-array status --short)"
      "Bash(./target/debug/mdma:*)"
      "Bash(devenv shell:*)"
      "Bash(tar -xzf ~/.cargo/registry/cache/index.crates.io-1949cf8c6b5b557f/zbus-5.14.0.crate)"
      "Bash(zig version:*)"
      "Bash(test:*)"
      "Bash(sort:*)"
      "Bash(cargo polylith profile:*)"
      "Bash(git -C /home/johlrogge/projects/modular-digital-music-array log --oneline --all -- .github/workflows/)"
      "Bash(git -C /home/johlrogge/projects/modular-digital-music-array ls-files profiles/dev/Cargo.toml)"
      "Bash(nix-instantiate --eval -E \"let n = builtins.getFlake file:///home/johlrogge/projects/modular-digital-music-array; in n.inputs | builtins.toJSON\")"
      "Bash(nix-instantiate --eval -E 'builtins.fromJSON \\(builtins.readFile /home/johlrogge/projects/modular-digital-music-array/.devenv/flake.json\\)')"
      # WebFetch domains
      "WebFetch(domain:docs.voidlinux.org)"
      "WebFetch(domain:voidlinux.org)"
      "WebFetch(domain:github.com)"
      "WebFetch(domain:raw.githubusercontent.com)"
      "WebFetch(domain:gist.github.com)"
      "WebFetch(domain:api.github.com)"
      "WebFetch(domain:wiki.archlinux.org)"
      "WebFetch(domain:man.archlinux.org)"
      "WebFetch(domain:alexwlchan.net)"
      "WebFetch(domain:devenv.sh)"
      "WebFetch(domain:docs.rs)"
      "WebFetch(domain:dannorth.net)"
      ...
      "WebFetch(domain:rekordbox.com)"
      "WebFetch(domain:cdn.rekordbox.com)"
      "WebFetch(domain:www.electrokit.com)"
      # Other
      "WebSearch"
      "Skill(architect)"
      "Read(//tmp/**)"
    ];
    # Only the three project-local servers; metadev's 14 are already provided.
    enabledMcpjsonServers = [ "just-ci" "just-deploy" "just-dev" ];
  }];
