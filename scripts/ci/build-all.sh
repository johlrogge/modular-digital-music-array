...
#
# profiles/dev/Cargo.toml is the dev workspace (generated by polylith profile build dev --no-build).
# profiles/production/Cargo.toml is used for mdma-acid (file-backed fact-store).
#
# Phase 0:  Generate dev profile workspace
...
echo "=== Phase 0: Generating dev workspace (polylith profile) ==="
