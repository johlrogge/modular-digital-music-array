#!/usr/bin/env bash
# Build mdma-audio for ARM64 (Raspberry Pi 5)
#
...
echo "Building mdma-audio for aarch64..."
...
echo ""
echo "Build complete"
file target/aarch64-unknown-linux-gnu/release/mdma-audio
ls -lh target/aarch64-unknown-linux-gnu/release/mdma-audio
